<h2><a href="https://leetcode.com/problems/median-of-a-row-wise-sorted-matrix">2387. Median of a Row Wise Sorted Matrix</a></h2><h3>Medium</h3><hr><p>Given an <code>m x n</code> matrix <code>grid</code> containing an <strong>odd</strong> number of integers where each row is sorted in <strong>non-decreasing</strong> order, return <em>the <strong>median</strong> of the matrix</em>.</p>
