<h2><a href="https://leetcode.com/problems/number-of-distinct-roll-sequences/?envType=company&envId=servicenow&favoriteSlug=servicenow-all&status=TO_DO">2318. Number of Distinct Roll Sequences</a></h2><h3>Hard</h3><hr><p>You are given an integer <code>n</code>. You roll a fair 6-sided dice <code>n</code> times. Determine the total number of <strong>distinct</strong> sequences of rolls possible such that the following conditions are satisfied:</p>
